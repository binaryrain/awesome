...
- [Structured Text Tools](https://github.com/dbohdan/structured-text-tools) - Command line tools for manipulating text-based data formats like DSV, JSON, YAML, etc.
